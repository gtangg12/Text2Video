...
sample_lips = np.load('downsample_preds_reprtemp.npy')
sample_times = np.load('downsample_times_reprtemp.npy')
...
for t, lip in tqdm(zip(sample_times, sample_lips)):
    ...
    cv2.imwrite(f'/media/william/DATA/6869/output_rnn/reprtemp/frame_{f}.jpg', im)
