...
sample_lips = np.load('downsample_preds_100e.npy')
sample_times = np.load('downsample_times_100e.npy')
...
for t, lip in tqdm(zip(sample_times, sample_lips)):
    ...
    cv2.imwrite(f'/media/william/DATA/6869/output_rnn/100e/frame_{f}.jpg', im)
