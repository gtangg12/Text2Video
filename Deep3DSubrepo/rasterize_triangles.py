...
def rasterize_triangles(vertices, attributes, triangles, projection_matrices,
  ...
  #vertex_ids = tf.reshape(vertex_ids, [batch_size, image_height, image_width, 3])
  #corrected_barycentric_coordinates = tf.reshape(corrected_barycentric_coordinates, [batch_size, image_height, image_width, 1])

  return vertex_ids, corrected_barycentric_coordinates, attributes_with_background, alphas
